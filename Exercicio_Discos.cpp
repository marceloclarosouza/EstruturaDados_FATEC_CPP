...
//
//	inserirListaFim(pMediaGeral, 10, "Maria", 0.0);
//	inserirListaFim(pMediaGeral, 20, "José", 0.0);
//	inserirListaFim(pMediaGeral, 30, "Jesus", 0.0);
//	
//	calcularMedia(pDiscBD, pDiscED, pMediaGeral);
//
