...
//exercicio4
/*Insira 5 elementos em uma fila.
Crie uma função que retire o primeiro elemento da fila e
coloque-o no final.
Chame a função 5 vezes para trocar de posição todos os
elementos da fila.
Entre uma chamada e outra da função, o programa deve
...
Fila inicial  { 1, 2, 3, 4, 5 }
1ª Chamada  { 2, 3, 4, 5, 1 }
Limpa a tela e Aguarda 5 s.
2ª Chamada  { 3, 4, 5, 1, 2 }
Limpa a tela e Aguarda 5 s.
3ª Chamada  { 4, 5, 1, 2, 3 }
Limpa a tela e Aguarda 5 s.
4ª Chamada  { 5, 1, 2, 3, 4 }
Limpa a tela e Aguarda 5 s.
5ª Chamada  { 1, 2, 3, 4, 5 }*/
